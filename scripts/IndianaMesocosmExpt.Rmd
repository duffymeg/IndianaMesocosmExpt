...
#The 'eggdata' file has averages calculated by Laura. To get sample sizes, will also import the raw egg data file:
raweggs<-readr::read_csv(here("data/raweggdata.csv"))

#not dealing with week issue -- doesn't apply to this analysis
