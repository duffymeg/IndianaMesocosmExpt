...
# figure1 <- plot_grid(propinfovertimeplot, meaninfprevplot, infdensityovertimeplot, meaninfhostplot, 
#                     popdensitytimeseries, meandensityplot, metschresevolplot, metschresevolplotgrouped, labels = "auto", ncol = 2, rel_heights = c(0.9, 0.9, 1, 0.8), align = 'vh')

totaldensityfigure <- popdensitytimeseriesmetsch + popdensitytimeseriesnometsch +
  plot_layout(nrow = 2) 

ylabel1 <- grid::textGrob('Prey density', x = 0.92, y = 0.5, rot = 90)
ylabel2 <- grid::textGrob('(LN prey per L + 1)', x = 0.92, y = 0.5, rot = 90)

# totaldensityfigurelabeled <- ylabel1 + ylabel2 +
  totaldensityfigure + 
  plot_layout(ncol = 3, widths = c(0.2,0.2,2))
...
figure1 <- propinfovertimeplot + meaninfprevplot + infdensityovertimeplot + meaninfhostplot + (popdensitytimeseriesmetsch / popdensitytimeseriesnometsch) + meandensityplot + (metschresevolplotmetsch / metschresevolplotnometsch) + metschresevolplotgrouped +
  ...
  grid::grid.draw(grid::textGrob(popdensityylab, x = 0.02, rot = 90))
